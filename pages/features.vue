<template>
  ...
  >
    <!-- Main Content -->
    <main class="mx-auto px-[57.5px] lg:px-0" style="max-width: 940px" ;>
      <!-- Features Section -->
      <section class=" " style="margin: 10% 0%">
        <div class="flex flex-col" style="align-items: flex-start">
          <!-- Section Label -->
         <SectionsUpername name="Multiple Features" />

          <!-- Title -->
          <h1
            class="text-center mb-4 sm:mb-6 text-[32px] font-semibold sm:text-4xl md:text-5xl lg:text-6xl"
            style="
          ...
          <!-- Subtitle -->
          <p
            class="text-left lg:text-center mb-8 sm:mb-10 md:mb-12 text-[14px] md:text-base"
            style="
            ...
            "
          >
            Get access to all of our features no matter the account size.
          </p>
        </div>

        <!-- Values Cards -->
        <div
          class="grid grid-cols-1 md:grid-cols-3 gap-[12px] mb-[6.25rem] lg:mb-[7.5rem]"
        >
          <!-- Agility Card -->
          <div
          ...
          >
            ...
            <div class="relative z-10 p-4 sm:p-5 md:p-6">
              ...
              <p
                ...
                "
              >
                Our primary focus is on speed, improving performance by a
          ...
          >
            ...
            <div class="relative z-10 p-4 sm:p-5 md:p-6">
              ...
              <p
                ...
                "
              >
                Our network can handle all levels of traffic, from a small blog
                to a top 10 website.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div class="relative z-10 p-4 sm:p-5 md:p-6">
                ...
                <div class="relative">
                  ...
                  <div class="z-10">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M2.65527 0.55542H31.234V29.8065H2.65527V0.55542Z"
                          fill="white"
                        />
                      </mask>
              ...
              <p
                ...
                "
              >
                Our resilient infrastructure and 24/7 customer support assures
                high reliability.
              </p>
            </div>
          </div>
      ...
      <!-- General Section -->
      <section class="w-full mx-auto mb-[2.5rem] md:mb-[5rem]">
        <div class="flex flex-col lg:flex-row gap-[0.875rem] md:gap-[2.5rem]">
          ...
          <div class="w-full lg:flex-1 flex items-center order-1 lg:order-2">
            <div>
              <h2
                class="mb-4 text-[24px] md:text-[32px] text-left"
                style="
                  font-family: 'Bricolage Grotesque', sans-serif;
                  font-weight: 600;
                  letter-spacing: -0.02em;
              ...
              <p
                class="text-left text-[0.8125rem] md:text-[1rem]"
                style="
                  font-family: 'Inter', sans-serif;
                  font-weight: 400;
                ...
                "
              >
                Global expectations for fast loading content is at an all-time
                high. Users expect content to be delivered at near instant
                speeds. We have built a high performance content delivery
                network that can meet the demands faced today and is ready for
      ...
      <!-- Security Section -->
      <section class="w-full mx-auto lg:px-0 mb-[2.5rem] md:mb-[6.25rem]">
          ...
          <div class="w-full lg:flex-1 flex items-center order-1">
            <div>
              ...
              <p
                ...
                "
              >
                Digital threats increase every day as the total number of people
                regularly accessing the internet grows. We understand the
                importance of a perfect uptime and rock solid security. We have
                proactively implemented many measures to prevent attacks and
      ...
      <section class="w-full mx-auto lg:px-0 mb-[6.25rem] md:mb-[7.625rem]" >
        <div class="flex flex-col lg:flex-row gap-8 sm:gap-10">
          ...
          <!-- Mobile/Tablet: Content Second, Desktop: Content Second -->
          <div class="w-full lg:flex-1 flex items-center md:order-2 order-1">
            <div>
              <h2
                class="mb-4 text-[24px] md:text-[32px] text-left"
                style="
              ...
              <p
                ...
                "
              >
                Every application typically has a large list of necessary
                requirements. We understand that adding a CDN service to a stack
                may become overwhelming. We have made sure that our platform can
                be easily configured to meet almost any specification.
              </p>
            </div>
          </div>
        </div>
      ...
      <section class="w-full mx-auto lg:px-0 mb-[6.25rem] md:mb-[7.625rem]">
        ...
        <!-- Title -->
        <h2
          class="text-start md:text-center mb-4 sm:mb-6 text-[32px] md:text-[48px]"
          style="
            font-family: 'Bricolage Grotesque', sans-serif;
            font-weight: 600;
            letter-spacing: -0.02em;
        ...
        <!-- Subtitle -->
        <p
          class="text-start md:text-center  mb-8 sm:mb-10 md:mb-12 text-sm md:text-base"
          style="
            font-family: 'Inter', sans-serif;
            font-weight: 400;
            font-size: 16px;
      ...
      <section class="w-full mx-auto lg:px-0" style="margin: 10% 0%">
        <!-- Section Label -->
        <div class="flex flex-col" style="align-items: flex-start">
          <div
          ...
          <!-- Title -->
          <h2
            class="text-left lg:text-center mb-4 sm:mb-6 text-[32px] md:text-[48px]"
            style="
              font-family: 'Bricolage Grotesque', sans-serif;
              font-weight: 600;
              letter-spacing: -0.02em;
        ...
        <div class="flex flex-col lg:flex-row gap-8 sm:gap-10">
          ...
          <div class="w-full lg:w-1/3">
            ...
            >
              <ul class="space-y-3">
                <li
                  class="flex items-center justify-between py-2 px-3 rounded-lg transition-colors bg-[#F7F7F8]"
                >
                  <span
                    style="
                      font-family: 'Inter', sans-serif;
                ...
                <li
                  class="flex items-center justify-between py-2 px-3 rounded-lg transition-colors hover:bg-gray-50"
                >
                  <span
                    style="
                      font-family: 'Inter', sans-serif;
          ...
          >
            ...
            <div class="w-full flex justify-center lg:hidden">
              <img
                src="/images/feature_lang_img2.png"
...
// Features list for General, Security, and Zones sections
const featuresList = [
  "HTTP/2",
  "IPv6 Support",
  "Header Control",
