      ...
      >
        <div>
          ...
          <p class="text-[15px]">
            ...
            your complete certificate including the intermediate certificates.
            You can then install them on your web server or CDN provider. It
            will also return the decoded certificate.
          </p>
        </div>
        <div>
