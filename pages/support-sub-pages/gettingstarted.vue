<template>
  <div>
    <div
      class="relative z-10 site-margins mb-[146.22px] mx-auto max-w-[855px] px-6"
    >
      <div
      ...
      >
        <aside class="space-y-[9.23px] font-medium text-[11.72px]">
          ...
          >
            <div
              class="group flex items-center justify-between w-full text-left px-3 py-2 text-[#757575] rounded-md transition-all hover:bg-white/50 cursor-default"
            >
              <span>Zones</span>
              <svg
        ...
        <main class="relative flex flex-col gap-[35px] z-10">
          <section>
            <CommonTitle
              ...
              subtitle="Setting up a CDN to work with your website is easy and can be done in just a few steps. The article How Does a CDN Work is a recommended read if you are not yet familiar with a content delivery network."
              pcAlignment="start"
          ...
          <section>
            <h2
              class="font-semibold text-[#1A1925] text-[1.5rem] md:text-[2rem] mb-1"
            >
              1. Create your Zone
            </h2>
            <p
          ...
          <section>
            ...
            <CodeSnippet :code="curlOutputCode" class="mb-4" />
...
const curlOutputCode = `curl -I https://zonename-hexid.kxcdn.com/path/to/example.css
HTTP/2 200
