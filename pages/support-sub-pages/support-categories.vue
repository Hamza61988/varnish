      ...
      <div class="relative z-10 px-6 pt-[4.25rem]">
        <div class="flex flex-col items-center text-center gap-[35px]">
          ...
          <div class="flex flex-col items-center gap-4">
            <div>
              <div
                ...
                "
                class="inline-flex items-center space-x-2 rounded-full border border-gray-100 "
              >
                <svg
            ...
            <p
              ...
              class="text-[#51515E] text-[16.07px]"
            >
          ...
          <div class="w-full space-y-4 ">
            ...
            <NuxtLink
              to="/support-categories/account-management"
              class="block w-full p-8 text-left  border border-[#EEEEF0] rounded-[20px] hover:border-gray-300 transition-colors"
            >
...
<path d="M633.785 573.704C656.376 425.798 632.407 281.836 561.396 218.415C478.73 144.586 332.315 179.907 121.391 445.224C242.485 -512.33 -213.359 515.652 -95.8792 60.2125" stroke="#EEEEF0" stroke-width="40" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
