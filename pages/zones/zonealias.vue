...
<template>
  <div class="">
    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="pl-6">
        <ol
          class="flex flex-col gap-4 text-[#73737F] text-[13px] md:text-[1rem]"
        >
          <li>
    ...
    <div class="mt-4 flex flex-col">
      ...
      <div class="my-6 pl-6 text-[#73737F] text-[13px] md:text-[1rem]">
        <ul class="list-disc">
    ...
    <div class="mt-4 flex flex-col">
      ...
      <div class="mt-4 flex flex-col">
        ...
        <p
          style="font-family: inter"
          class="text-[#73737F] text-[13px] md:text-[1rem] underline"
        >
